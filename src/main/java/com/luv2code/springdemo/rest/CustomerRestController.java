...
//video 494 from here we change and add rest
...
public class CustomerRestController {
	...
	public Customer addCustomer(@RequestBody Customer theCustomer) {
		...
		//this is force a save of new item..insted of update../see502 video or daocustomerimp
		theCustomer.setId(0);
		customerService.saveCustomer(theCustomer);
		return theCustomer;
		//to add in postman must do body then raw then json where next to graph then write
